...
\textbf{Chords:} \emph{vers}: \code{Bm A E}; \emph{refreng}: \code{Bm A E}, \emph{bridge}: 4x
\code{G F\#m Bm A F\#m G A}.
...
\textbf{Chords:} \emph{vers}: \code{Bm A E}; \emph{refreng}: \code{Bm A E}.
...
\paragraph{Chords:}
\emph{vers}: \code{E7 A7 E7 B7 E E7 A7 C7 E7 B7 E7}; \emph{bridge}: \code{A7 B7 A7 E7}
...
\textbf{Chords:} \emph{vers}: \code{G F C G F C G}; \emph{refreng}: \code{2x G D C G}
